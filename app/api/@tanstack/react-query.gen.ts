...
import { getConfigApiPyConfigGet, type Options, postCompletionsApiPyCompletionsPost, updateConfigApiPyConfigPost } from '../sdk.gen';
import type { GetConfigApiPyConfigGetData, GetConfigApiPyConfigGetResponse, PostCompletionsApiPyCompletionsPostData, PostCompletionsApiPyCompletionsPostError, PostCompletionsApiPyCompletionsPostResponse, UpdateConfigApiPyConfigPostData, UpdateConfigApiPyConfigPostError, UpdateConfigApiPyConfigPostResponse } from '../types.gen';
...
export const getConfigApiPyConfigGetQueryKey = (options?: Options<GetConfigApiPyConfigGetData>) => createQueryKey('getConfigApiPyConfigGet', options);
...
export const getConfigApiPyConfigGetOptions = (options?: Options<GetConfigApiPyConfigGetData>) => queryOptions<GetConfigApiPyConfigGetResponse, DefaultError, GetConfigApiPyConfigGetResponse, ReturnType<typeof getConfigApiPyConfigGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getConfigApiPyConfigGet({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getConfigApiPyConfigGetQueryKey(options)
});
...
export const updateConfigApiPyConfigPostMutation = (options?: Partial<Options<UpdateConfigApiPyConfigPostData>>): UseMutationOptions<UpdateConfigApiPyConfigPostResponse, UpdateConfigApiPyConfigPostError, Options<UpdateConfigApiPyConfigPostData>> => {
    const mutationOptions: UseMutationOptions<UpdateConfigApiPyConfigPostResponse, UpdateConfigApiPyConfigPostError, Options<UpdateConfigApiPyConfigPostData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateConfigApiPyConfigPost({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
